    ...
    >
      <div>
        ...
        <div className="relative h-56 w-full overflow-hidden bg-slate-100">
          ...
          {/* Badges on Image - Light & Regular */}
          <div className="absolute top-3 left-3 flex flex-wrap gap-1.5 z-10">
            {vendor.verified && (
              <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full bg-violet-700/90 backdrop-blur-md text-white text-[11px] font-light shadow-sm border border-violet-400/40">
                <ShieldCheck className="w-3.5 h-3.5 text-amber-300 stroke-[1.5]" />
                <span>Verified Vendor</span>
              </span>
            )}
            {vendor.cacRegistered && (
              <span className="inline-flex items-center space-x-1 px-2 py-1 rounded-full bg-amber-500/90 backdrop-blur-md text-white text-[10px] font-light">
                <Award className="w-3 h-3 text-amber-100 stroke-[1.5]" />
          ...
          <div className="absolute bottom-3 left-3 z-10">
            <span className="px-3 py-1 rounded-xl bg-violet-950/80 backdrop-blur-sm text-amber-300 text-xs font-light border border-violet-500/30">
